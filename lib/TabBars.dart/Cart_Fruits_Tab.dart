...
class cart_fruit_tab extends StatefulWidget {
  const cart_fruit_tab({Key? key}) : super(key: key);

  @override
  State<cart_fruit_tab> createState() => _cart_fruit_tabState();
}

class _cart_fruit_tabState extends State<cart_fruit_tab> {
